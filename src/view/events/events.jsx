  ...
  return (
    <div className="w-full h-max flex flex-col items-center gap-4 mt-2" id="events">
      <div className="text-center flex flex-col justify-center items-center w-full h-max">
        ...
        <p className=' uppercase tracking-[2px]' data-aos="fade-right" data-aos-duration="800">save the date</p>
      </div>
      <p className="sacramento font-medium text-[1.8rem]" data-aos="fade-left" data-aos-duration="1000">04 . Maret . 2023</p>
